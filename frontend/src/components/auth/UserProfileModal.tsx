...
export function UserProfileModal({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="md" placement="center" className="z-[100] modal">
      <ModalContent className="bg-gradient-to-br from-[#32CD32] via-[#7CFC00] to-[#90EE90] rounded-lg shadow-xl w-full max-w-md mx-auto p-4 sm:p-6 modal-content min-h-[400px] flex flex-col
        ...
        {() => (
          <>
            <ModalHeader className="flex flex-col gap-1 text-center mobile:pb-3 xs:pb-2">
              <h3 className="text-xl font-bold text-black mobile:text-lg xs:text-base">Your Profile</h3>
            </ModalHeader>
            <ModalBody className="px-2 sm:px-4 py-4 flex-1 flex flex-col mobile:px-1 mobile:py-3 xs:px-0 xs:py-2">
              ...
              xs:p-2 xs:gap-1">
                  <div className="flex items-center gap-3 mobile:flex-col mobile:gap-2 xs:gap-1">
                    ...
                    <div>
                      <p className="text-black font-medium mobile:text-sm xs:text-xs mobile:break-all">
                ...
                {userInfo?.email && (
                  <div className="w-full bg-white text-black rounded-md px-4 py-2 text-center font-medium text-sm truncate
                ...
                <Button
                 ...
                 px-4 py-2 rounded-md border border-black shadow-md
