...
export function Sidebar() {
  ...
  const menuItems: MenuItem[] = [
    ...
    { icon: "lucide:git-branch", label: "v0.2", path: "", component: <div className="flex ml-2 items-center gap-2 p-1 text-sm text-gray-500 font-normal"><Icon icon="lucide:git-branch" className="text-gray-500" /> v0.2.1</div> },
  ];
